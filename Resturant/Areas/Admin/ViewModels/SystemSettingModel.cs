...
namespace Resturant.Areas.Admin.ViewModels
{
    public class SystemSettingModel : BaseEntity
    {
        ...
        public IFormFile? LogoImageUrl { get; set; } = null!;
        public IFormFile? LogoImageUrl2 { get; set; } = null!;
        public IFormFile?  WelcomeNoteImageUrl { get; set; } = null!;

        // for booking table description
        [Display(Name = "Booking Table Description")]
        public string? TransactionBookTableDesc { get; set; } = null!;
        public List<SystemSetting>? SystemSettings { get; set; } = null!;
    }
}
